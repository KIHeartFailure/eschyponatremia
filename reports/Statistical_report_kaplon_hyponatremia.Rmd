...
From now on the term "all patients" refers to patients with Non-missing sodium at admission. 
...
used to model the time to first event. Adjustment was performed for variables indicated with 2 in Table \ref{tab:tab1all} 
...
Modelled using univariable logistic regression for the variables shown in Table \ref{tab:tab1all}-\ref{tab:tab2ex} 
